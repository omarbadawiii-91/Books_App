            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Fieldfortext(text: "Email Address",icon: Icon(Icons.email),controller: emailController,validator: (Value)=>Value!.isEmpty?"Please Enter Email Address":null,),
                ),
                Padding(
                  padding:  EdgeInsets.all(15),
                  child: Fieldfortext(text: "Password",icon: Icon(Icons.remove_red_eye_outlined),controller: passwordController,validator: (Value)=>Value!.isEmpty?"Please Enter Password":null,),
                ),
                Align(
                ...
                Padding(
                  ...
                  child: Button(text: "Login",color: Colors.cyan,width: 200, onTap: () async{
 ...
 Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomepageScreen(),));
  ...
  if (mounted) {  
    if (e.code == 'user-not-found' || e.code == 'invalid-email') {
      Constantwidgetrepeated().messagesforemail("Email Address is not found. Please try again!", context);
    } else if (e.code == 'wrong-password') {
      Constantwidgetrepeated().messagesforpassword("Password is wrong. Please try again!", context);
    } else if (e.code == 'The email address is badly formatted') {  
      Constantwidgetrepeated().messagesforpassword("Email Address is not valid.", context);
    } 
